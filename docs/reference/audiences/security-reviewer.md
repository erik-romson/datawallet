...
- **Crypto sources: libsodium only.** Never `java.security.SecureRandom` or
  ...
  *Where it is enforced:* all random bytes flow through
  [`crypto/Random.java#L7-L14`](../../../src/main/java/com/wilhelmsen/cbslink/plugin/datawallet/crypto/Random.java#L7-L14),
...
- **Auth is opaque 32-byte bearer tokens.** No cookies, no CSRF surface, no
  ...
  *Where it is enforced:* token extraction and session lookup in
  [`security/BearerAuthFilter.java#L39-L58`](../../../src/main/java/com/wilhelmsen/cbslink/plugin/datawallet/security/BearerAuthFilter.java#L39-L58).
...
- **Time is UTC milliseconds since epoch** as `uint` in CBOR/JSON;
  ...
  *Where it is enforced:* session and audit timestamps are stored as
  ...
  [`audit/HashChainAuditService.java#L59-L61`](../../../src/main/java/com/wilhelmsen/cbslink/plugin/datawallet/audit/HashChainAuditService.java#L59-L61)
...
|---|---|---|
| Bearer-token validation | [`security/BearerAuthFilter.java#L39-L58`](../../../src/main/java/com/wilhelmsen/cbslink/plugin/datawallet/security/BearerAuthFilter.java#L39-L58) | [`specs/plan.md` §4.4](../../specs/plan.md#44-session-token) |
| Argon2id KDF (key derivation) | [`crypto/Argon2id.java#L16-L37`](../../../src/main/java/com/wilhelmsen/cbslink/plugin/datawallet/crypto/Argon2id.java#L16-L37) | [`specs/plan.md` §6](../../specs/plan.md#6-verifier-account-creation-and-login) |
| Argon2id parameter floor (min cost) | [`api/verifier/Argon2idFloor.java`](../../../src/main/java/com/wilhelmsen/cbslink/plugin/datawallet/api/verifier/Argon2idFloor.java) | [`specs/plan.md` §6](../../specs/plan.md#argon2id-parameter-floor-h2) |
| Nonce sourcing via libsodium | [`crypto/Random.java#L7-L14`](../../../src/main/java/com/wilhelmsen/cbslink/plugin/datawallet/crypto/Random.java#L7-L14) | [`specs/crypto-formats.md`](../../specs/crypto-formats.md) |
| mTLS issuer cert authentication | [`security/X509IssuerPrincipalResolver.java#L19-L50`](../../../src/main/java/com/wilhelmsen/cbslink/plugin/datawallet/security/X509IssuerPrincipalResolver.java#L19-L50) | [`specs/plan.md` §3](../../specs/plan.md#3-keys-and-trust-distribution) |
| Audit hash chain (tamper-evident log) | [`audit/HashChainAuditService.java#L50-L66`](../../../src/main/java/com/wilhelmsen/cbslink/plugin/datawallet/audit/HashChainAuditService.java#L50-L66) | [`specs/plan.md` §8.1](../../specs/plan.md#81-audit-log) |
...
| Token-bucket rate limiting | [`ratelimit/RateLimitService.java#L44-L65`](../../../src/main/java/com/wilhelmsen/cbslink/plugin/datawallet/ratelimit/RateLimitService.java#L44-L65) | [`specs/plan.md` §10](../../specs/plan.md#10-tasks) |
| Authentication lockout (progressive) | [`ratelimit/AuthLockoutService.java#L50-L64`](../../../src/main/java/com/wilhelmsen/cbslink/plugin/datawallet/ratelimit/AuthLockoutService.java#L50-L64) | [`specs/plan.md` §6](../../specs/plan.md#6-verifier-account-creation-and-login) |
...
| Directory record signature verification | [`directory/DirectoryRecordVerifier.java`](../../../src/main/java/com/wilhelmsen/cbslink/plugin/datawallet/directory/DirectoryRecordVerifier.java) | [`specs/plan.md` §4.3](../../specs/plan.md#43-directory-record) |
...
[`api/admin/AdminAuditController.java`](../../../src/main/java/com/wilhelmsen/cbslink/plugin/datawallet/api/admin/AdminAuditController.java)
...
- **Mint a directory entry.** Only the offline root keypair can produce a valid
  ...
  pinned root via
  [`directory/DirectoryRecordVerifier.java`](../../../src/main/java/com/wilhelmsen/cbslink/plugin/datawallet/directory/DirectoryRecordVerifier.java)
