...
import com.wilhelmsen.cbslink.plugin.datawallet.crypto.SealedBox;
...
import com.wilhelmsen.cbslink.plugin.datawallet.envelope.RecipientWrapping;
import com.wilhelmsen.cbslink.plugin.datawallet.envelope.SharedEnvelope;
...
public class VerifierFetchCommand implements Callable<Integer> {
    ...
    private static byte[] derivePublicFromSecret(byte[] secret) {
        ...
        int rc = com.wilhelmsen.cbslink.plugin.datawallet.crypto.CryptoProvider.sodium()
